...
public class EgovUserInfManageDAO extends EgovAbstractMapper {
	...
	return (Integer)selectByPk("EgovUserInfManageDAO.selectUserListCnt", userVO);
    }
	...
	return (Integer)selectByPk("EgovUserInfManageDAO.selectCmmntyUserListCnt", userVO);
    }
	...
	return (Integer)selectByPk("EgovUserInfManageDAO.selectCmmntyMngrListCnt", userVO);
    }
	...
	return (Integer)selectByPk("EgovUserInfManageDAO.selectClubUserListCnt", userVO);
    }
	...
	return (Integer)selectByPk("EgovUserInfManageDAO.selectClubOprtrListCnt", userVO);
    }
